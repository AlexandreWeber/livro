...
O comando SWITCH permite a execução de um trecho de código de acordo com cada opção (CASE). O SWITCH pode ser uma alternativa ao IF quando houverem muitas validações a serem executadas. Um ponto importante é que o SWITCH é recomendado quando as condições a serem validadas possuem valores pré-definidos.
...
No trecho de código abaixo temos a variável diaDaSemana e estamos realizando um teste com o **SWITCH**.
